import { usersRepo } from "../../test.repositories";
...
describe('mealsController', () => {
    ...
    describe('search', () => {
        it('should return an array of meals', async () => {
            ...
            jest.spyOn(mealsService, 'search').mockImplementation(() => result);
    ...
    describe('create', () => {
        it('should return a new meal', async () => {
            ...
            jest.spyOn(mealsService, 'create').mockImplementation(() => result);
    ...
    describe('rate', () => {
        it('should return a new rating', async () => {
            const result = RatingsFactory
                .getDtoInstance('meal', 'user', 5);
            jest.spyOn(mealsService, 'rate')
